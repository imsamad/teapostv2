...
// @access  Public
const confirmRegistration = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const confirmation = yield Confirmation_1.default.findOne({
        ...
        type: Confirmation_1.CONFIRMATION_ENUM["REGISTRATION_CONFIRM"],
    });
    if (!confirmation)
...
exports.default = confirmRegistration;
