...
const forgotPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Confirmation_1.default.deleteMany({
        user: user._id.toString(),
        type: Confirmation_1.CONFIRMATION_ENUM["RESET_PASSWORD"],
    });
    ...
    const redirectUrl = `${req.protocol}://${req.get("host")}/api/v1/auth/confirm/resetPassword/${token}`;
    const resObj = {
...
exports.default = [(0, validate_request_1.validateRequest)(payloadSchema, "body"), forgotPassword];
